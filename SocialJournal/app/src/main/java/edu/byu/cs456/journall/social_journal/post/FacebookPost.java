...
public class FacebookPost extends Post {
    ...
    public String toString() {
        if (url == null) {
            return "<iframe src=\"https://www.facebook.com/plugins/web_view.php?href=https%3A%2F%2Fwww.facebook.com%2FStudentProblems%2Fposts%2F1184336055026459%3A0&width=500\" width=\"500\" height=\"589\" style=\"border:none;overflow:hidden\" scrolling=\"no\" frameborder=\"0\" allowTransparency=\"true\"></iframe>";
        } else {
            return url;
        }
    }
